...
let chunSeBeiJingTag = document.getElementById("chunSeBeiJing"); //背景设置-纯色背景单选框
...
//纯色背景
chunSeBeiJingTag.addEventListener("change", setChunSeBeiJing);
function setChunSeBeiJing() {
  chunSeBeiJingTag.checked = true;
